...
const ManageWaterForm = () => {
  ...
  return (
    <div>
      <Form form={formInfoWater} layout="vertical">
        <div>
        ...
        <div className="flex justify-end mt-5">
          ...
          >
            <Button type='text' htmlType="submit" className='button-cancel mr-5 font-bold h-[40px]'>
              Kembali
            </Button>
            <Button type='text' htmlType="submit" className='bg-[#F7B648] text-white font-bold h-[40px]'>
              Simpan
            </Button>
          </ConfigProvider>
        </div>
